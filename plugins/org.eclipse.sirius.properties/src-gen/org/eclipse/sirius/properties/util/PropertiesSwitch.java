...
public class PropertiesSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case PropertiesPackage.IMAGE_VIEWER_DESCRIPTION: {
            ImageViewerDescription imageViewerDescription = (ImageViewerDescription) theEObject;
            T result = caseImageViewerDescription(imageViewerDescription);
            if (result == null) {
                result = caseWidgetDescription(imageViewerDescription);
            }
            if (result == null) {
        ...
        case PropertiesPackage.IMAGE_VIEWER_WIDGET_STYLE: {
            ImageViewerWidgetStyle imageViewerWidgetStyle = (ImageViewerWidgetStyle) theEObject;
            T result = caseImageViewerWidgetStyle(imageViewerWidgetStyle);
            if (result == null) {
                result = caseWidgetStyle(imageViewerWidgetStyle);
            }
            if (result == null) {
                result = defaultCase(theEObject);
            }
        ...
        case PropertiesPackage.IMAGE_VIEWER_WIDGET_CONDITIONAL_STYLE: {
            ImageViewerWidgetConditionalStyle imageViewerWidgetConditionalStyle = (ImageViewerWidgetConditionalStyle) theEObject;
            T result = caseImageViewerWidgetConditionalStyle(imageViewerWidgetConditionalStyle);
            if (result == null) {
                result = caseWidgetConditionalStyle(imageViewerWidgetConditionalStyle);
            }
            if (result == null) {
                result = defaultCase(theEObject);
            }
    ...
    /**
     * Returns the result of interpreting the object as an instance of
     * '<em>Image Viewer Description</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of
     *         '<em>Image Viewer Description</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of
     * '<em>Image Viewer Widget Style</em>'. <!-- begin-user-doc --> This
     * implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of
     *         '<em>Image Viewer Widget Style</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseImageViewerWidgetStyle(ImageViewerWidgetStyle object) {
        return null;
    }
     ...
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of
     *         '<em>Image Viewer Widget Conditional Style</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseImageViewerWidgetConditionalStyle(ImageViewerWidgetConditionalStyle object) {
        return null;
    }
