...
public class TableNavigationDescriptionItemProvider extends RepresentationNavigationDescriptionItemProvider {
    ...
    protected void addTableDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_TableNavigationDescription_tableDescription_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_TableNavigationDescription_tableDescription_feature", "_UI_TableNavigationDescription_type"),
                DescriptionPackage.Literals.TABLE_NAVIGATION_DESCRIPTION__TABLE_DESCRIPTION, true, false, true, null, getString("_UI_GeneralPropertyCategory"), null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/TableNavigationDescription"));
    }
