...
public class PropertiesItemProviderAdapterFactory extends PropertiesAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.properties.DateDescription} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected DateDescriptionItemProvider dateDescriptionItemProvider;

    /**
     * This creates an adapter for a
     * {@link org.eclipse.sirius.properties.DateDescription}. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createDateDescriptionAdapter() {
        if (dateDescriptionItemProvider == null) {
            dateDescriptionItemProvider = new DateDescriptionItemProvider(this);
        }

        return dateDescriptionItemProvider;
    }
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.properties.DateWidgetStyle} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected DateWidgetStyleItemProvider dateWidgetStyleItemProvider;

    /**
     * This creates an adapter for a
     * {@link org.eclipse.sirius.properties.DateWidgetStyle}. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createDateWidgetStyleAdapter() {
        if (dateWidgetStyleItemProvider == null) {
            dateWidgetStyleItemProvider = new DateWidgetStyleItemProvider(this);
        }

        return dateWidgetStyleItemProvider;
    }
     ...
     * @generated
     */
    protected DateWidgetConditionalStyleItemProvider dateWidgetConditionalStyleItemProvider;
    ...
    public Adapter createDateWidgetConditionalStyleAdapter() {
        if (dateWidgetConditionalStyleItemProvider == null) {
            dateWidgetConditionalStyleItemProvider = new DateWidgetConditionalStyleItemProvider(this);
        }

        return dateWidgetConditionalStyleItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (dateDescriptionItemProvider != null) {
            dateDescriptionItemProvider.dispose();
        }
        if (widgetStyleItemProvider != null) {
        ...
        if (dateWidgetStyleItemProvider != null) {
            dateWidgetStyleItemProvider.dispose();
        }
        if (groupStyleItemProvider != null) {
        ...
        if (dateWidgetConditionalStyleItemProvider != null) {
            dateWidgetConditionalStyleItemProvider.dispose();
        }
        if (widgetActionItemProvider != null) {
