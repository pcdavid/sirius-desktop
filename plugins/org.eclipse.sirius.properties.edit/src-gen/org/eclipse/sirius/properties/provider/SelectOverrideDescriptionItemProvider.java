 ...
 * {@link org.eclipse.sirius.properties.SelectOverrideDescription} object. <!--
...
public class SelectOverrideDescriptionItemProvider extends AbstractSelectDescriptionItemProvider {
     ...
     * Overridden Select Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * This returns SelectOverrideDescription.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((SelectOverrideDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_SelectOverrideDescription_type") : //$NON-NLS-1$
                getString("_UI_SelectOverrideDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
