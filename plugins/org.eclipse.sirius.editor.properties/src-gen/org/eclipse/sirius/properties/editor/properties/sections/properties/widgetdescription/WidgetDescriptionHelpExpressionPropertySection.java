...
/**
 * A section for the helpExpression property of a WidgetDescription object.
 */
public class WidgetDescriptionHelpExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WidgetDescriptionHelpExpressionPropertySection.this, text.getText());
                dialog.open();
