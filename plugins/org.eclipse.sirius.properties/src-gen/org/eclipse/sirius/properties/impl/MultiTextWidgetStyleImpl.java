 ...
 * Text Widget Style</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.impl.MultiTextWidgetStyleImpl#getFontNameExpression
 * <em>Font Name Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.MultiTextWidgetStyleImpl#getFontSizeExpression
 * <em>Font Size Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.MultiTextWidgetStyleImpl#getBackgroundColor
 * <em>Background Color</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.MultiTextWidgetStyleImpl#getForegroundColor
 * <em>Foreground Color</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.MultiTextWidgetStyleImpl#getFontFormat
 * <em>Font Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiTextWidgetStyleImpl extends WidgetStyleImpl implements MultiTextWidgetStyle {
    /**
     ...
     * @ordered
     */
    protected String fontNameExpression = MultiTextWidgetStyleImpl.FONT_NAME_EXPRESSION_EDEFAULT;
     ...
     * @ordered
     */
    protected String fontSizeExpression = MultiTextWidgetStyleImpl.FONT_SIZE_EXPRESSION_EDEFAULT;
     ...
     * @generated
     */
    protected MultiTextWidgetStyleImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return PropertiesPackage.Literals.MULTI_TEXT_WIDGET_STYLE;
    }
    ...
    public void setFontNameExpression(String newFontNameExpression) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_NAME_EXPRESSION, oldFontNameExpression, fontNameExpression));
        }
    }
    ...
    public void setFontSizeExpression(String newFontSizeExpression) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_SIZE_EXPRESSION, oldFontSizeExpression, fontSizeExpression));
        }
    }
    ...
    public ColorDescription getBackgroundColor() {
        if (backgroundColor != null && backgroundColor.eIsProxy()) {
            ...
            if (backgroundColor != oldBackgroundColor) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
                }
            }
        }
    ...
    public void setBackgroundColor(ColorDescription newBackgroundColor) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
        }
    }
    ...
    public ColorDescription getForegroundColor() {
        if (foregroundColor != null && foregroundColor.eIsProxy()) {
            ...
            if (foregroundColor != oldForegroundColor) {
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
                }
            }
        }
    ...
    public void setForegroundColor(ColorDescription newForegroundColor) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
        }
    }
    ...
    public EList<FontFormat> getFontFormat() {
        if (fontFormat == null) {
            fontFormat = new EDataTypeUniqueEList<FontFormat>(FontFormat.class, this, PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_FORMAT);
        }
        return fontFormat;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__BACKGROUND_COLOR:
            if (resolve) {
                return getBackgroundColor();
            }
            return basicGetBackgroundColor();
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FOREGROUND_COLOR:
            if (resolve) {
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_NAME_EXPRESSION:
            setFontNameExpression(MultiTextWidgetStyleImpl.FONT_NAME_EXPRESSION_EDEFAULT);
            return;
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_SIZE_EXPRESSION:
            setFontSizeExpression(MultiTextWidgetStyleImpl.FONT_SIZE_EXPRESSION_EDEFAULT);
            return;
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__BACKGROUND_COLOR:
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_NAME_EXPRESSION:
            return MultiTextWidgetStyleImpl.FONT_NAME_EXPRESSION_EDEFAULT == null ? fontNameExpression != null : !MultiTextWidgetStyleImpl.FONT_NAME_EXPRESSION_EDEFAULT.equals(fontNameExpression);
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__FONT_SIZE_EXPRESSION:
            return MultiTextWidgetStyleImpl.FONT_SIZE_EXPRESSION_EDEFAULT == null ? fontSizeExpression != null : !MultiTextWidgetStyleImpl.FONT_SIZE_EXPRESSION_EDEFAULT.equals(fontSizeExpression);
        case PropertiesPackage.MULTI_TEXT_WIDGET_STYLE__BACKGROUND_COLOR:
