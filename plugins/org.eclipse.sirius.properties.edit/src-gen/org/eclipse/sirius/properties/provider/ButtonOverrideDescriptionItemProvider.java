 ...
 * {@link org.eclipse.sirius.properties.ButtonOverrideDescription} object. <!--
...
public class ButtonOverrideDescriptionItemProvider extends AbstractButtonDescriptionItemProvider {
     ...
     * Overridden Button Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * This returns ButtonOverrideDescription.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((ButtonOverrideDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_ButtonOverrideDescription_type") : //$NON-NLS-1$
                getString("_UI_ButtonOverrideDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
