...
implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addReusePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_VSMElementCustomizationReuse_reuse_feature"),
                        getString("_UI_VSMElementCustomizationReuse_reuse_description"), DescriptionPackage.Literals.VSM_ELEMENT_CUSTOMIZATION_REUSE__REUSE, true, false, true, null, null, null));
    }
