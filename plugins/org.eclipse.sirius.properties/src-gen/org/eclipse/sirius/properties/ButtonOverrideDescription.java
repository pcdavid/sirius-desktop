 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.ButtonOverrideDescription#getOverrides
 * <em>Overrides</em>}</li>
...
public interface ButtonOverrideDescription extends AbstractButtonDescription, AbstractOverrideDescription {
     ...
     * Overridden Button Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Conditional Styles From Overridden
     * Button Expression</em>' attribute isn't clear, there really should be
     ...
     *            Overridden Button Expression</em>' attribute.
