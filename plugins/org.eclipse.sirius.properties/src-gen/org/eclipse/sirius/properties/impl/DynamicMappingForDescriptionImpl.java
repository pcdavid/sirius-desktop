 ...
 * Mapping For Description</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.impl.DynamicMappingForDescriptionImpl#getIterator
 * <em>Iterator</em>}</li>
 ...
 * <li>{@link org.eclipse.sirius.properties.impl.DynamicMappingForDescriptionImpl#getIfs
 * <em>Ifs</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.DynamicMappingForDescriptionImpl#getExtends
 * <em>Extends</em>}</li>
...
public class DynamicMappingForDescriptionImpl extends ControlDescriptionImpl implements DynamicMappingForDescription {
     ...
     * '{@link #getFilterIfsFromExtendedDynamicMappingForExpression() <em>Filter
     * Ifs From Extended Dynamic Mapping For Expression</em>}' attribute. <!--
