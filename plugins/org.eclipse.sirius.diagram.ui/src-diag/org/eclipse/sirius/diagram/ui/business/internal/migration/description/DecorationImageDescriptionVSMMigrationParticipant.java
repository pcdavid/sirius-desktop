...
/**
 * This VSM migration participant handles the migration from feature name change
 * from DecorationDescription.decoratorPath to
...
public class DecorationImageDescriptionVSMMigrationParticipant extends AbstractVSMMigrationParticipant {
     ...
     */
    public static final Version MIGRATION_VERSION = new Version("11.1.1.201612201200"); //$NON-NLS-1$
