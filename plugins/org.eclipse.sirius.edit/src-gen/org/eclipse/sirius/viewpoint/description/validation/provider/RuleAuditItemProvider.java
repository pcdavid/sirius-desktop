...
implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addAuditExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_RuleAudit_auditExpression_feature"), getString("_UI_RuleAudit_auditExpression_description"), ValidationPackage.Literals.RULE_AUDIT__AUDIT_EXPRESSION, true, false, false,
