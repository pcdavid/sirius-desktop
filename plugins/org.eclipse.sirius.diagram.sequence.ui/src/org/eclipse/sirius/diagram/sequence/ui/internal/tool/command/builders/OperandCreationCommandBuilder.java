 ...
 * @author edugueperoux
 */
public class OperandCreationCommandBuilder extends ContainerCreationCommandBuilder {
    ...
    protected DCommand createEnclosingCommand() {
        return new SequenceCreatedEventsFlaggingSiriusCommand(editingDomain, getEnclosingCommandLabel(), diagram, Operand.viewpointElementPredicate());
    }
