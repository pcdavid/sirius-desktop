...
public class SessionEditorInputTests extends TestCase {
    ...
    public void testSessionEditorInputWithInputURIChange() {
        ...
        String representationAssertMessage = "DRepresentation's URI should not have hanged as they are stored in a InMemoryResourceImpl with uid based uriFragment";
        ...
        String gmfAssertMessage = "GMF diagram's URI should have hanged as they are stored in a InMemoryResourceImpl with xpath based uriFragment";
