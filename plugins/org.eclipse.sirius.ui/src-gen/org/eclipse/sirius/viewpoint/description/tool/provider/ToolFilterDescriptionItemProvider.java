 ...
 * @generated
 */
public class ToolFilterDescriptionItemProvider extends AbstractSiriusItemProvider
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addElementsToListenPropertyDescriptor(object);
        }
    ...
    protected void addPreconditionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ToolFilterDescription_precondition_feature"), //$NON-NLS-1$
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ToolPackage.Literals.TOOL_FILTER_DESCRIPTION__LISTENERS);
        }
    ...
    /**
     * This returns ToolFilterDescription.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ToolFilterDescription.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.TOOL_FILTER_DESCRIPTION__LISTENERS, ToolFactory.eINSTANCE.createFeatureChangeListener()));
    }
