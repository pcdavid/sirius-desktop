...
The configuration of a _Markdown_ widget is minimal. Beside the standard properties available on all widgets like _Label Expression_, _Help Expression_ and _Is Enabled Expression_, you only need to specify:


* _Num of line_ : The number of lines to be displayed.
...
h4(#markdown_widget_styles). Reference Style
...
The configuration of a _HTML renderer_ widget is minimal. Beside the standard properties available on all widgets like _Label Expression_, _Help Expression_ and _Is Enabled Expression_, you only need to specify:
...
* _Num of line_ : The number of lines to be displayed, which determines the height of the _HTML Rendered_ widget. Be aware that this is an estimation. Indeed the text size modification done by CSS styling is not used here.
...
h4(#html_renderer_styles). Reference Style
