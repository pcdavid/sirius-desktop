 ...
 * {@link org.eclipse.sirius.viewpoint.DAnalysisCustomData} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class DAnalysisCustomDataItemProvider extends AbstractSiriusItemProvider
     ...
     * @generated
     */
    public DAnalysisCustomDataItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addKeyPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DAnalysisCustomData_key_feature"), //$NON-NLS-1$
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ViewpointPackage.Literals.DANALYSIS_CUSTOM_DATA__DATA);
        }
    ...
    /**
     * This returns DAnalysisCustomData.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DAnalysisCustomData.class)) {
