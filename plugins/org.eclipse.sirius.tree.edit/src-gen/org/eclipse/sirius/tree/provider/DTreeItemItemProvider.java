...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.tree.DTreeItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DTreeItemItemProvider extends DTreeItemContainerItemProvider {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_DRepresentationElement_name_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DRepresentationElement_name_feature",
						"_UI_DRepresentationElement_type"),
				ViewpointPackage.Literals.DREPRESENTATION_ELEMENT__NAME, true,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_DRepresentationElement_semanticElements_feature",
								"_UI_DRepresentationElement_type"),
						ViewpointPackage.Literals.DREPRESENTATION_ELEMENT__SEMANTIC_ELEMENTS,
	...
	protected void addTreeElementMappingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_DTreeElement_treeElementMapping_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DTreeElement_treeElementMapping_feature",
						"_UI_DTreeElement_type"),
				TreePackage.Literals.DTREE_ELEMENT__TREE_ELEMENT_MAPPING,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_DTreeItem_expanded_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_DTreeItem_expanded_feature",
								"_UI_DTreeItem_type"),
						TreePackage.Literals.DTREE_ITEM__EXPANDED, true, false,
	...
	protected void addActualMappingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_DTreeItem_actualMapping_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DTreeItem_actualMapping_feature",
						"_UI_DTreeItem_type"),
				TreePackage.Literals.DTREE_ITEM__ACTUAL_MAPPING, true, false,
				true, null, null, null));
	}
	...
	protected void addStyleUpdaterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_DTreeItem_styleUpdater_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DTreeItem_styleUpdater_feature",
						"_UI_DTreeItem_type"),
				TreePackage.Literals.DTREE_ITEM__STYLE_UPDATER, false, false,
	...
	protected void addUpdaterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_DTreeItem_updater_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_DTreeItem_updater_feature", "_UI_DTreeItem_type"),
				TreePackage.Literals.DTREE_ITEM__UPDATER, false, false, true,
				null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/DTreeItem"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DTreeItem_type")
				: getString("_UI_DTreeItem_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				TreePackage.Literals.DTREE_ITEM__OWNED_STYLE,
				TreeFactory.eINSTANCE.createTreeItemStyle()));
	}
