...
/**
 * Property section for "to HTML expression" feature of the HTML renderer widget description.
 * 
 * @author Arthur Daussy
 *
 */
@SuppressWarnings("restriction")
public class ExtHTMLRendererDescriptionToHTMLExpressionPropertySection extends AbstractTextWithButtonPropertySection {

    @Override
    protected String getDefaultLabelText() {
        return Messages.ExtHTMLRendererDescriptionToHTMLExpressionPropertySection_DefaultLabel;
    }
    ...
    protected String getToolTipText() {
        return Messages.ExtHTMLRendererDescriptionToHTMLExpressionPropertySection_Tooltip;
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ExtHTMLRendererDescriptionToHTMLExpressionPropertySection.this, text.getText());
                dialog.open();
