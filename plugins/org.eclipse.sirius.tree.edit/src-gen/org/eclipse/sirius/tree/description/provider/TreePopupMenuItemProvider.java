 ...
 * @generated
 */
public class TreePopupMenuItemProvider extends
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_POPUP_MENU__MENU_ITEM_DESCRIPTIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TreePopupMenu"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery((TreePopupMenu) object)
				.getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreePopupMenu_type")
				: getString("_UI_TreePopupMenu_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TreePopupMenu.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_POPUP_MENU__MENU_ITEM_DESCRIPTIONS,
						ToolFactory.eINSTANCE
