...
* <span class="label label-info">Modified</span> The content of the package @org.eclipse.sirius.editor.properties@ was exposed as an API without any reason, it has now been moved to the private package @org.eclipse.sirius.editor.properties.internal@
