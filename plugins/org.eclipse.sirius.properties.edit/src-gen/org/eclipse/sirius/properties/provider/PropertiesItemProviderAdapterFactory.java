...
public class PropertiesItemProviderAdapterFactory extends PropertiesAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.properties.FilePickerDescription} instances.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected FilePickerDescriptionItemProvider filePickerDescriptionItemProvider;

    /**
     * This creates an adapter for a
     * {@link org.eclipse.sirius.properties.FilePickerDescription}. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public Adapter createFilePickerDescriptionAdapter() {
        if (filePickerDescriptionItemProvider == null) {
            filePickerDescriptionItemProvider = new FilePickerDescriptionItemProvider(this);
        }

        return filePickerDescriptionItemProvider;
    }
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.properties.FilePickerWidgetStyle} instances.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected FilePickerWidgetStyleItemProvider filePickerWidgetStyleItemProvider;

    /**
     * This creates an adapter for a
     * {@link org.eclipse.sirius.properties.FilePickerWidgetStyle}. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public Adapter createFilePickerWidgetStyleAdapter() {
        if (filePickerWidgetStyleItemProvider == null) {
            filePickerWidgetStyleItemProvider = new FilePickerWidgetStyleItemProvider(this);
        }

        return filePickerWidgetStyleItemProvider;
    }
     ...
     * @generated
     */
    protected FilePickerWidgetConditionalStyleItemProvider filePickerWidgetConditionalStyleItemProvider;
    ...
    public Adapter createFilePickerWidgetConditionalStyleAdapter() {
        if (filePickerWidgetConditionalStyleItemProvider == null) {
            filePickerWidgetConditionalStyleItemProvider = new FilePickerWidgetConditionalStyleItemProvider(this);
        }

        return filePickerWidgetConditionalStyleItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (filePickerDescriptionItemProvider != null) {
            filePickerDescriptionItemProvider.dispose();
        }
        if (widgetStyleItemProvider != null) {
        ...
        if (filePickerWidgetStyleItemProvider != null) {
            filePickerWidgetStyleItemProvider.dispose();
        }
        if (groupStyleItemProvider != null) {
        ...
        if (filePickerWidgetConditionalStyleItemProvider != null) {
            filePickerWidgetConditionalStyleItemProvider.dispose();
        }
        if (groupConditionalStyleItemProvider != null) {
