 ...
 * {@link org.eclipse.sirius.properties.TextAreaOverrideDescription} object.
...
public class TextAreaOverrideDescriptionItemProvider extends AbstractTextAreaDescriptionItemProvider {
     ...
     * Overridden Text Area Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * This returns TextAreaOverrideDescription.gif. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((TextAreaOverrideDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_TextAreaOverrideDescription_type") : //$NON-NLS-1$
                getString("_UI_TextAreaOverrideDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
