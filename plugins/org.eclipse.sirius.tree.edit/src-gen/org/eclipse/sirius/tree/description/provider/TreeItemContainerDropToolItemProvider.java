 ...
 * @generated
 */
public class TreeItemContainerDropToolItemProvider extends
	...
	protected void addDragSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_TreeItemContainerDropTool_dragSource_description"),
						DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__DRAG_SOURCE,
						true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__OLD_CONTAINER);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_CONTAINER);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__ELEMENT);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_VIEW_CONTAINER);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__PRECEDING_SIBLINGS);
			childrenFeatures
	...
	/**
	 * This returns TreeItemContainerDropTool.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/TreeItemContainerDropTool"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery(
				(TreeItemContainerDropTool) object).getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeItemContainerDropTool_type")
				: getString("_UI_TreeItemContainerDropTool_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(
		...
		ItemProviderHelper.filterChildDescriptorsByType(newChildDescriptors,
				TreeItemContainerDropToolItemProvider.TYPES_TO_HIDE);
	}
	...
	protected void collectNewChildDescriptorsGen(
		...
		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__OLD_CONTAINER,
						ToolFactory.eINSTANCE.createDropContainerVariable()));

		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_CONTAINER,
						ToolFactory.eINSTANCE.createDropContainerVariable()));

		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__ELEMENT,
						ToolFactory.eINSTANCE.createElementDropVariable()));

		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_VIEW_CONTAINER,
						ToolFactory.eINSTANCE.createContainerViewVariable()));

		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__PRECEDING_SIBLINGS,
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__OLD_CONTAINER
