...
public class DialogVariableItemProvider extends AbstractVariableItemProvider {
    ...
    protected void addDialogPromptPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DialogVariable_dialogPrompt_feature"), getString("_UI_DialogVariable_dialogPrompt_description"), ToolPackage.Literals.DIALOG_VARIABLE__DIALOG_PROMPT, true, false, false,
