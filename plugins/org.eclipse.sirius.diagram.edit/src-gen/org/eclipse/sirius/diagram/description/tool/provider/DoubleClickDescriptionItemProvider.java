...
public class DoubleClickDescriptionItemProvider extends MappingBasedToolDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ToolPackage.Literals.DOUBLE_CLICK_DESCRIPTION__ELEMENT);
            childrenFeatures.add(ToolPackage.Literals.DOUBLE_CLICK_DESCRIPTION__ELEMENT_VIEW);
            childrenFeatures.add(ToolPackage.Literals.DOUBLE_CLICK_DESCRIPTION__INITIAL_OPERATION);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DoubleClickDescription.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.DOUBLE_CLICK_DESCRIPTION__ELEMENT, ToolFactory.eINSTANCE.createElementDoubleClickVariable()));
