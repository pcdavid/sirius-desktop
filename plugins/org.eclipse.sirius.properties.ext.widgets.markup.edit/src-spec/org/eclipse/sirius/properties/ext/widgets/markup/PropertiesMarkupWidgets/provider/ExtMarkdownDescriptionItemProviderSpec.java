...
public class ExtMarkdownDescriptionItemProviderSpec extends ExtMarkdownDescriptionItemProvider {

	public ExtMarkdownDescriptionItemProviderSpec(AdapterFactory adapterFactory) {
	...
	public Object getStyledText(Object object) {
		return Utils.computeLabel(this, object, "_UI_ExtMarkdownDescription_type"); //$NON-NLS-1$
	}
	...
	public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtMarkdownDescription.png")); //$NON-NLS-1$
	}
