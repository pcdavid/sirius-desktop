 ...
 * @generated
 */
public class TreeItemDragToolItemProvider extends
		MappingBasedToolDescriptionItemProvider {
	private static final Collection<EClass> TYPES_TO_HIDE = Lists
			.newArrayList(ToolPackage.Literals.DELETE_VIEW);
	...
	protected void addContainersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_TreeItemDragTool_containers_feature"),
				getString("_UI_TreeItemDragTool_containers_description"),
				DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__CONTAINERS,
	...
	protected void addDragSourceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_TreeItemDragTool_dragSourceType_feature"),
						getString("_UI_TreeItemDragTool_dragSourceType_description"),
						DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__DRAG_SOURCE_TYPE,
						true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_TOOL__VARIABLES);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__OLD_CONTAINER);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__NEW_CONTAINER);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__ELEMENT);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__NEW_VIEW_CONTAINER);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__PRECEDING_SIBLINGS);
			childrenFeatures
					.add(DescriptionPackage.Literals.TREE_ITEM_TOOL__FIRST_MODEL_OPERATION);
		}
	...
	/**
	 * This returns TreeItemDragTool.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TreeItemDragTool"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery((TreeItemDragTool) object)
				.getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeItemDragTool_type")
				: getString("_UI_TreeItemDragTool_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(
		...
		ItemProviderHelper.filterChildDescriptorsByType(newChildDescriptors,
				TreeItemDragToolItemProvider.TYPES_TO_HIDE);
	}
	...
	protected void collectNewChildDescriptorsGen(
		...
		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_TOOL__FIRST_MODEL_OPERATION,
		...
		newChildDescriptors.add(createChildParameter(
				DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__OLD_CONTAINER,
				ToolFactory.eINSTANCE.createDropContainerVariable()));

		newChildDescriptors.add(createChildParameter(
				DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__NEW_CONTAINER,
				ToolFactory.eINSTANCE.createDropContainerVariable()));

		newChildDescriptors.add(createChildParameter(
				DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__ELEMENT,
				ToolFactory.eINSTANCE.createElementDropVariable()));

		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__NEW_VIEW_CONTAINER,
						ToolFactory.eINSTANCE.createContainerViewVariable()));

		newChildDescriptors
				.add(createChildParameter(
						DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__PRECEDING_SIBLINGS,
						DescriptionFactory.eINSTANCE
								.createPrecedingSiblingsVariables()));
	}
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__OLD_CONTAINER
				|| childFeature == DescriptionPackage.Literals.TREE_ITEM_DRAG_TOOL__NEW_CONTAINER;
