...
public class TreeVariableItemProvider extends AbstractVariableItemProvider {
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_TreeVariable_documentation_feature",
						"_UI_TreeVariable_type"),
				DescriptionPackage.Literals.TREE_VARIABLE__DOCUMENTATION, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ToolPackage.Literals.VARIABLE_CONTAINER__SUB_VARIABLES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TreeVariable"));
	}
	...
	public String getText(Object object) {
		...
		return StringUtil.isEmpty(label) ? getString("_UI_TreeVariable_type")
				: getString("_UI_TreeVariable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TreeVariable.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ToolPackage.Literals.VARIABLE_CONTAINER__SUB_VARIABLES,
