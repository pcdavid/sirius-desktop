...
public class DiagramRepairParticipant implements IRepairParticipant {
    ...
    private List<Diagram> getGMFDiagrams(Collection<Resource> resources) {
        ...
        for (Resource resource : resources) {
            resource.getContents().stream().filter(DDiagram.class::isInstance).map(DDiagram.class::cast).forEach(dDiagram -> {
    ...
    private Collection<Resource> getAllDiagramResources(DView view) {
        ...
        for (DRepresentationDescriptor descriptor : view.getOwnedRepresentationDescriptors()) {
            ...
            if (representation != null) {
                Resource currentResource = representation.eResource();
