 ...
 * {@link org.eclipse.sirius.properties.AbstractSelectDescription} object. <!--
...
public class AbstractSelectDescriptionItemProvider extends AbstractWidgetDescriptionItemProvider {
    ...
    public String getText(Object object) {
        String label = crop(((AbstractSelectDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_AbstractSelectDescription_type") : //$NON-NLS-1$
                getString("_UI_AbstractSelectDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(AbstractSelectDescription.class)) {
