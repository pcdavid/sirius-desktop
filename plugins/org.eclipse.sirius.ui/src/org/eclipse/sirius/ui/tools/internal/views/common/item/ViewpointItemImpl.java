...
public class ViewpointItemImpl implements ViewpointItem, Comparable<ViewpointItemImpl>, ItemDecorator, IAdaptable {
    ...
    public String getText() {
        return isSafeViewpoint() ? new IdentifiedElementQuery(viewpoint).getLabel() : "\"Not found\"";
    }

    @Override
    public Image getImage() {
        return SiriusUiPlugin.getPlugin().getImage(SiriusUiPlugin.getPlugin().getItemImageDescriptor(viewpoint));
    }
}
