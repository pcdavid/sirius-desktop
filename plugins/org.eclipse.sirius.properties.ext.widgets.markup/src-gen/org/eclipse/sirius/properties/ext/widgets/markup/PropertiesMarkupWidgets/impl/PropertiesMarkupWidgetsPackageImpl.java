...
public class PropertiesMarkupWidgetsPackageImpl extends EPackageImpl implements PropertiesMarkupWidgetsPackage {
    ...
    public void initializePackageContents() {
        ...
        initEClass(extHTMLRendererDescriptionEClass, ExtHTMLRendererDescription.class, "ExtHTMLRendererDescription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getExtHTMLRendererDescription_ToHtmlExpression(), theDescriptionPackage.getInterpretedExpression(), "toHtmlExpression", null, 0, 1, ExtHTMLRendererDescription.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getExtHTMLRendererDescription_ValueExpression(), theDescriptionPackage.getInterpretedExpression(), "valueExpression", null, 0, 1, ExtHTMLRendererDescription.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getExtHTMLRendererDescription_NumberOfLines(), theEcorePackage.getEInt(), "numberOfLines", null, 0, 1, ExtHTMLRendererDescription.class, !IS_TRANSIENT, !IS_VOLATILE, //$NON-NLS-1$
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExtHTMLRendererDescription_InitialOperation(), theToolPackage.getInitialOperation(), null, "initialOperation", null, 0, 1, ExtHTMLRendererDescription.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getExtHTMLRendererDescription_EditionToolExpression(), theDescriptionPackage.getInterpretedExpression(), "editionToolExpression", null, 0, 1, ExtHTMLRendererDescription.class, //$NON-NLS-1$
                !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getExtHTMLRendererDescription_CssExpression(), theDescriptionPackage.getInterpretedExpression(), "cssExpression", null, 0, 1, ExtHTMLRendererDescription.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(extMarkdownDescriptionEClass, ExtMarkdownDescription.class, "ExtMarkdownDescription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
        initEAttribute(getExtMarkdownDescription_ValueExpression(), theDescriptionPackage.getInterpretedExpression(), "valueExpression", null, 0, 1, ExtMarkdownDescription.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getExtMarkdownDescription_NumberOfLines(), theEcorePackage.getEInt(), "numberOfLines", null, 0, 1, ExtMarkdownDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, //$NON-NLS-1$
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExtMarkdownDescription_InitialOperation(), theToolPackage.getInitialOperation(), null, "initialOperation", null, 0, 1, ExtMarkdownDescription.class, !IS_TRANSIENT, //$NON-NLS-1$
                !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
