 ...
 * @generated
 */
public class TreeNavigationDescriptionItemProvider extends
		RepresentationNavigationDescriptionItemProvider {
	/**
	...
	protected void addTreeDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_TreeNavigationDescription_treeDescription_feature"),
						getString("_UI_TreeNavigationDescription_treeDescription_description"),
						DescriptionPackage.Literals.TREE_NAVIGATION_DESCRIPTION__TREE_DESCRIPTION,
						true, false, true, null,
						getString("_UI_GeneralPropertyCategory"), null));
	}

	/**
	 * This returns TreeNavigationDescription.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/TreeNavigationDescription"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery(
				(TreeNavigationDescription) object).getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeNavigationDescription_type")
				: getString("_UI_TreeNavigationDescription_type") + " " + label;
	}
