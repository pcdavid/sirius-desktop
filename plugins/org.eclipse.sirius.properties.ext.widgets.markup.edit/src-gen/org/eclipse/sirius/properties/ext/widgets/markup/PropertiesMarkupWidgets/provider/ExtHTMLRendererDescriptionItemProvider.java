...
public class ExtHTMLRendererDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    protected void addToHtmlExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExtHTMLRendererDescription_toHtmlExpression_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", "_UI_ExtHTMLRendererDescription_toHtmlExpression_feature", "_UI_ExtHTMLRendererDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addValueExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExtHTMLRendererDescription_valueExpression_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", "_UI_ExtHTMLRendererDescription_valueExpression_feature", "_UI_ExtHTMLRendererDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addNumberOfLinesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExtHTMLRendererDescription_numberOfLines_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", "_UI_ExtHTMLRendererDescription_numberOfLines_feature", "_UI_ExtHTMLRendererDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addEditionToolExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExtHTMLRendererDescription_editionToolExpression_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", "_UI_ExtHTMLRendererDescription_editionToolExpression_feature", "_UI_ExtHTMLRendererDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addCssExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExtHTMLRendererDescription_cssExpression_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", "_UI_ExtHTMLRendererDescription_cssExpression_feature", "_UI_ExtHTMLRendererDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtHTMLRendererDescription")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ExtHTMLRendererDescription_type") : //$NON-NLS-1$
                getString("_UI_ExtHTMLRendererDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == PropertiesMarkupWidgetsPackage.Literals.EXT_HTML_RENDERER_DESCRIPTION__INITIAL_OPERATION;
