...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Diagram Description</b></em>'. <!--
 * end-user-doc -->
 *
...
public interface DiagramDescription extends DragAndDropTargetDescription, RepresentationDescription, PasteTargetDescription {
     ...
     * end-user-doc --> <!-- begin-model-doc --> Filters that are owned by this simple mapping. <!-- end-model-doc -->
     *
     ...
     * end-user-doc --> <!-- begin-model-doc --> All concerns of the viewpoint. A concern is a set of filters,
     ...
     * end-user-doc --> <!-- begin-model-doc --> The predicate that allows (or not) to create a viewpoint from a Meta
     * Class. <!-- end-model-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Default Concern</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * --> <!-- begin-model-doc --> The default concern to use. <!-- end-model-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Init</b></em>' reference. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Returns the value of the '<em><b>Diagram Initialisation</b></em>' containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Diagram Initialisation</em>' containment reference isn't clear, there really should be
    ...
    /**
     * Returns the value of the '<em><b>Default Layer</b></em>' containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Default Layer</em>' containment reference isn't clear, there really should be more of
     * a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Additional Layers</b></em>' containment reference list. The list contents are of
     * type {@link org.eclipse.sirius.diagram.description.AdditionalLayer}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Additional Layers</em>' containment reference list isn't clear, there really should be
     * more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Edge Mapping Imports</b></em>' containment reference list. The list contents are
     * of type {@link org.eclipse.sirius.diagram.description.EdgeMappingImport}. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> Edge mapping imports that are owned by this simple mapping. <!--
     * end-model-doc -->
     *
     * @return the value of the '<em>Edge Mapping Imports</em>' containment reference list.
    ...
    /**
     * Returns the value of the '<em><b>Container Mappings</b></em>' containment reference list. The list contents are
     * of type {@link org.eclipse.sirius.diagram.description.ContainerMapping}. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> container mappings that are owned by this simple mapping. <!--
     * end-model-doc -->
     *
     * @return the value of the '<em>Container Mappings</em>' containment reference list.
    ...
    /**
     * Returns the value of the '<em><b>Reused Mappings</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.sirius.diagram.description.DiagramElementMapping}. <!-- begin-user-doc --> <!-- end-user-doc
     * --> <!-- begin-model-doc --> The reused mappings. <!-- end-model-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Tool Section</b></em>' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> A tool section encloses many tools <!-- end-model-doc -->
     *
     ...
     * {@link org.eclipse.sirius.viewpoint.description.tool.AbstractToolDescription} . <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> Tools that are reused by this viewpoint. <!-- end-model-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Enable Popup Bars</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * --> <!-- begin-model-doc --> Boolean indicating whether or not to show dynamic popup bars with creation tools.
     * <!-- end-model-doc -->
     *
