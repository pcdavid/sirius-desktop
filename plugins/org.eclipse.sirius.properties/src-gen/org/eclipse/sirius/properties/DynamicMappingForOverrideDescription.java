 ...
 * Mapping For Override Description</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.DynamicMappingForOverrideDescription#getOverrides
 * <em>Overrides</em>}</li>
...
public interface DynamicMappingForOverrideDescription extends AbstractDynamicMappingForDescription, AbstractOverrideDescription {
    ...
    /**
     * Returns the value of the '<em><b>Filter Ifs From Overridden Dynamic
     * Mapping For Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Ifs From Overridden Dynamic Mapping For
     * Expression</em>' attribute isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Filter Ifs From Overridden Dynamic Mapping
     ...
     *
     * @param value
     *            the new value of the '<em>Filter Ifs From Overridden Dynamic
