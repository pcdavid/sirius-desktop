 ...
 * @generated
 */
public class RepresentationTemplateItemProvider extends AbstractSiriusItemProvider
     ...
     * @generated
     */
    public RepresentationTemplateItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_RepresentationTemplate_name_feature"), //$NON-NLS-1$
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DescriptionPackage.Literals.REPRESENTATION_TEMPLATE__OWNED_REPRESENTATIONS);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(RepresentationTemplate.class)) {
