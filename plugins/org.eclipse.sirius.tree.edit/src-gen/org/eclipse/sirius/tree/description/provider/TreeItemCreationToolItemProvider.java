...
public class TreeItemCreationToolItemProvider extends TreeItemToolItemProvider {
	...
	protected void addMappingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_TreeItemCreationTool_mapping_feature"),
				getString("_UI_TreeItemCreationTool_mapping_description"),
				DescriptionPackage.Literals.TREE_ITEM_CREATION_TOOL__MAPPING,
				true, false, true, null,
				getString("_UI_GeneralPropertyCategory"), null));
	}

	/**
	 * This returns TreeItemCreationTool.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator()
						.getImage("full/obj16/TreeItemCreationTool"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery((TreeItemCreationTool) object)
				.getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeItemCreationTool_type")
				: getString("_UI_TreeItemCreationTool_type") + " " + label;
	}
