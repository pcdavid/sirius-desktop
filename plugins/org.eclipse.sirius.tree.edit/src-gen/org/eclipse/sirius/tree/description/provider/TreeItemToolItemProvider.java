 ...
 * @generated
 */
public class TreeItemToolItemProvider extends
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery((TreeItemTool) object)
				.getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeItemTool_type")
				: getString("_UI_TreeItemTool_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(
		...
		ItemProviderHelper.filterChildDescriptorsByType(newChildDescriptors,
				TreeItemToolItemProvider.TYPES_TO_HIDE);
	}
