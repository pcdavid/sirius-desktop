...
/**
 * Property section for "css expression" feature of the HTML renderer widget description.
 * 
 * @author Arthur Daussy
 *
 */
@SuppressWarnings("restriction")
public class ExtHTMLRendererDescriptionCSSExpressionPropertySection extends AbstractTextWithButtonPropertySection {

	@Override
	protected String getDefaultLabelText() {
        return Messages.ExtHTMLRendererDescriptionCSSExpressionPropertySection_DefaultLabel;
	}
	...
	protected String getToolTipText() {
        return Messages.ExtHTMLRendererDescriptionCSSExpressionPropertySection_Tooltip;
	}

	@Override
	public EAttribute getFeature() {
		return PropertiesMarkupWidgetsPackage.eINSTANCE.getExtHTMLRendererDescription_CssExpression();
	}
		...
		return new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
						ExtHTMLRendererDescriptionCSSExpressionPropertySection.this, text.getText());
				dialog.open();
