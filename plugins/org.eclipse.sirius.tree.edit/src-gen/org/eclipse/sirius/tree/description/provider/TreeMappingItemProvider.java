 ...
 * @generated
 */
public class TreeMappingItemProvider extends
		RepresentationElementMappingItemProvider {
	/**
	...
	protected void addSemanticElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_TreeMapping_semanticElements_feature"),
				getString("_UI_TreeMapping_semanticElements_description"),
				DescriptionPackage.Literals.TREE_MAPPING__SEMANTIC_ELEMENTS,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TreeMapping"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery((TreeMapping) object)
				.getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeMapping_type")
				: getString("_UI_TreeMapping_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TreeMapping.class)) {
