...
public class PropertiesItemProviderAdapterFactory extends PropertiesAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.properties.ImageViewerDescription} instances.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected ImageViewerDescriptionItemProvider imageViewerDescriptionItemProvider;
    ...
    public Adapter createImageViewerDescriptionAdapter() {
        if (imageViewerDescriptionItemProvider == null) {
            imageViewerDescriptionItemProvider = new ImageViewerDescriptionItemProvider(this);
        }
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link org.eclipse.sirius.properties.ImageViewerWidgetStyle} instances.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected ImageViewerWidgetStyleItemProvider imageViewerWidgetStyleItemProvider;
    ...
    public Adapter createImageViewerWidgetStyleAdapter() {
        if (imageViewerWidgetStyleItemProvider == null) {
            imageViewerWidgetStyleItemProvider = new ImageViewerWidgetStyleItemProvider(this);
        }

        return imageViewerWidgetStyleItemProvider;
    }
     ...
     * @generated
     */
    protected ImageViewerWidgetConditionalStyleItemProvider imageViewerWidgetConditionalStyleItemProvider;
    ...
    public Adapter createImageViewerWidgetConditionalStyleAdapter() {
        if (imageViewerWidgetConditionalStyleItemProvider == null) {
            imageViewerWidgetConditionalStyleItemProvider = new ImageViewerWidgetConditionalStyleItemProvider(this);
        }

        return imageViewerWidgetConditionalStyleItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (imageViewerWidgetStyleItemProvider != null) {
            imageViewerWidgetStyleItemProvider.dispose();
        }
        if (groupStyleItemProvider != null) {
        ...
        if (imageViewerWidgetConditionalStyleItemProvider != null) {
            imageViewerWidgetConditionalStyleItemProvider.dispose();
        }
        if (groupConditionalStyleItemProvider != null) {
