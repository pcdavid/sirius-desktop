...
import org.eclipse.sirius.diagram.ui.tools.internal.decoration.DescribedDecorator;
import org.eclipse.sirius.diagram.ui.tools.internal.decoration.DescribedDecoratorProvider;
...
public class DecoratorsTest extends GenericTestCase {
    ...
    private void checkDecoration(final List<DDiagramElement> elements, final GenericDecorationDescription decorationDescription) {
        for (final DDiagramElement diagramElement : elements) {
            checkDecoration(diagramElement, decorationDescription);
        }
    }

    private void checkDecoration(final DDiagramElement diagramElement, final GenericDecorationDescription decorationDescription) {
