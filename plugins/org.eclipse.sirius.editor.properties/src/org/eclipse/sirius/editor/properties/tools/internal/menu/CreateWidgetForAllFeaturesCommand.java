...
/**
 * Creates all the widget descriptions with values for each structural feature
 * of the selected domain class.
 * 
 * @author sbegaudeau
 * @author arichard
 */
public class CreateWidgetForAllFeaturesCommand extends AbstractUndoRecordingCommand {
    ...
    protected void doExecute() {
        EList<EStructuralFeature> eAllStructuralFeatures = this.descriptor.getDomainClass().getEAllStructuralFeatures();
    ...
    protected String getText() {
        return MessageFormat.format(Messages.CreateWidgetForAllFeaturesCommand_text, this.descriptor.getDomainClass().getName());
    }
