...
public class PageValidationSetDescriptionItemProvider extends ItemProviderAdapter
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(PropertiesPackage.Literals.PAGE_VALIDATION_SET_DESCRIPTION__SEMANTIC_VALIDATION_RULES);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(PageValidationSetDescription.class)) {
