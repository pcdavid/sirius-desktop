...
public class SubDiagramDecorationDescriptorProvider implements SiriusDecorationDescriptorProvider {
    ...
    public boolean provides(IDiagramElementEditPart editPart) {
        ...
        if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
            ...
            if (view != null) {
                ...
                provides = model instanceof DNode || model instanceof DDiagramElementContainer;
    ...
    @Override
    public List<DecorationDescriptor> getDecorationDescriptors(IDiagramElementEditPart editPart) {
