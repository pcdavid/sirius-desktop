 ...
 * {@link org.eclipse.sirius.properties.AbstractTextDescription} object. <!--
...
public class AbstractTextDescriptionItemProvider extends AbstractWidgetDescriptionItemProvider {
     ...
     * Extended Text Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((AbstractTextDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_AbstractTextDescription_type") : //$NON-NLS-1$
                getString("_UI_AbstractTextDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
