...
public class ComputedColorItemProvider extends UserColorItemProvider {
    ...
    protected void addRedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ComputedColor_red_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_ComputedColor_red_feature", "_UI_ComputedColor_type"), DescriptionPackage.Literals.COMPUTED_COLOR__RED, true, false, false,
