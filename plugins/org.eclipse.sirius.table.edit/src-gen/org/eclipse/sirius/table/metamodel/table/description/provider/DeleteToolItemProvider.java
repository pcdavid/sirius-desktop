...
public class DeleteToolItemProvider extends AbstractToolDescriptionItemProvider {
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DeleteTool.class)) {
        case DescriptionPackage.DELETE_TOOL__VARIABLES:
        case DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION:
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        ItemProviderHelper.filterChildDescriptorsByType(newChildDescriptors, DeleteToolItemProvider.TYPES_TO_HIDE);
    }
