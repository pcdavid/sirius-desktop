 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.LabelOverrideDescription#getOverrides
 * <em>Overrides</em>}</li>
...
public interface LabelOverrideDescription extends AbstractLabelDescription, AbstractOverrideDescription {
     ...
     * Overridden Label Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Conditional Styles From Overridden
     * Label Expression</em>' attribute isn't clear, there really should be more
     ...
     *            Overridden Label Expression</em>' attribute.
    ...
    /**
     * Returns the value of the '<em><b>Filter Actions From Overridden Label
     * Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Actions From Overridden Label
     * Expression</em>' attribute isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Filter Actions From Overridden Label
     ...
     * <em>Filter Actions From Overridden Label Expression</em>}' attribute.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Filter Actions From Overridden Label
     *            Expression</em>' attribute.
