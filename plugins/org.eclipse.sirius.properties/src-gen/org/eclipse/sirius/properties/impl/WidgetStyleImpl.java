 ...
 * <li>{@link org.eclipse.sirius.properties.impl.WidgetStyleImpl#getLabelBackgroundColor
 * <em>Label Background Color</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.WidgetStyleImpl#getLabelForegroundColor
 * <em>Label Foreground Color</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.impl.WidgetStyleImpl#getLabelFontFormat
...
public class WidgetStyleImpl extends MinimalEObjectImpl.Container implements WidgetStyle {
    /**
     * The default value of the '{@link #getLabelFontNameExpression() <em>Label
     * Font Name Expression</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getLabelFontNameExpression() <em>Label
     * Font Name Expression</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getLabelFontNameExpression()
    ...
    /**
     * The default value of the '{@link #getLabelFontSizeExpression() <em>Label
     * Font Size Expression</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getLabelFontSizeExpression() <em>Label
     * Font Size Expression</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getLabelFontSizeExpression()
    ...
    /**
     * The cached value of the '{@link #getLabelBackgroundColor() <em>Label
     * Background Color</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getLabelForegroundColor() <em>Label
     * Foreground Color</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getLabelFontFormat() <em>Label Font
     * Format</em>}' attribute list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
