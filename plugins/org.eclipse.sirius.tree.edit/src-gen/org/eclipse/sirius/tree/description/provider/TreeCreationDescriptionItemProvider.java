...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.tree.description.TreeCreationDescription} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class TreeCreationDescriptionItemProvider extends
		RepresentationCreationDescriptionItemProvider {
	/**
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_TreeCreationDescription_treeDescription_feature",
								"_UI_TreeCreationDescription_type"),
						DescriptionPackage.Literals.TREE_CREATION_DESCRIPTION__TREE_DESCRIPTION,
						true, false, true, null,
						getString("_UI_GeneralPropertyCategory"), null));
	}

	/**
	 * This returns TreeCreationDescription.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/TreeCreationDescription"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery(
				(TreeCreationDescription) object).getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeCreationDescription_type")
				: getString("_UI_TreeCreationDescription_type") + " " + label;
	}
