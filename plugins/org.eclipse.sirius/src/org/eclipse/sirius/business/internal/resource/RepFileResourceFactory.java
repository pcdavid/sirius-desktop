...
/**
 * A new Factory to create a specific resource for *.repfile.
 * 
 * @author Florian Barbin
 *
 */
public class RepFileResourceFactory extends XMIResourceFactoryImpl {
    ...
    public Resource createResource(final URI uri) {
        ...
        // migrationIsNeeded =
        // RepresentationsFileMigrationService.getInstance().isMigrationNeeded(Version.parseVersion(loadedVersion));
        // }
    ...
    protected XMIResource doCreateResource(URI uri) {
        return new RepFileXMIResourceImpl(uri);
    }
