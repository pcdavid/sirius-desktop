...
public class TreeDescriptionItemProvider extends DocumentedElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_TreeDescription_domainClass_feature"),
						getString("_UI_TreeDescription_domainClass_description"),
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__DOMAIN_CLASS,
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						getString("_UI_GeneralPropertyCategory"), null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_TreeDescription_preconditionExpression_feature"),
						getString("_UI_TreeDescription_preconditionExpression_description"),
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__PRECONDITION_EXPRESSION,
						true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						getString("_UI_AdvancedPropertyCategory"), null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_ITEM_MAPPING_CONTAINER__SUB_ITEM_MAPPINGS);
			childrenFeatures
					.add(org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_ITEM_MAPPING_CONTAINER__DROP_TOOLS);
			childrenFeatures
					.add(org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__CREATE_TREE_ITEM);
			childrenFeatures
					.add(org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__OWNED_REPRESENTATION_CREATION_DESCRIPTIONS);
			childrenFeatures
					.add(org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__OWNED_REPRESENTATION_NAVIGATION_DESCRIPTIONS);
		}
	...
	/**
	 * This returns TreeDescription.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TreeDescription"));
	}
	...
	public String getText(Object object) {
		final String label = new IdentifiedElementQuery(
				(TreeDescription) object).getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeDescription_type")
				: label;
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_ITEM_MAPPING_CONTAINER__SUB_ITEM_MAPPINGS,
						newItemMapping));
	...
	private void collectDnDToolChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_ITEM_MAPPING_CONTAINER__DROP_TOOLS,
						dropTool));
	}
	...
	protected void collectNewChildDescriptorsGen(
		...
		newChildDescriptors
				.add(createChildParameter(
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__CREATE_TREE_ITEM,
						DescriptionFactory.eINSTANCE
								.createTreeItemCreationTool()));

		newChildDescriptors
				.add(createChildParameter(
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__OWNED_REPRESENTATION_CREATION_DESCRIPTIONS,
						DescriptionFactory.eINSTANCE
								.createTreeCreationDescription()));

		newChildDescriptors
				.add(createChildParameter(
						org.eclipse.sirius.tree.description.DescriptionPackage.Literals.TREE_DESCRIPTION__OWNED_REPRESENTATION_NAVIGATION_DESCRIPTIONS,
						DescriptionFactory.eINSTANCE
								.createTreeNavigationDescription()));
	}
