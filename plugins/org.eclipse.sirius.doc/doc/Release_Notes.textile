...
* <span class="label label-success">Added</span> AnalysisSelectorFilteredItemsSelectionDialog has been created in order to have custom analysis selector provider able to modify the analysis selector dialog.
