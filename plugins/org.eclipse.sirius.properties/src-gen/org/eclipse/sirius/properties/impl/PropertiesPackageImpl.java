...
public class PropertiesPackageImpl extends EPackageImpl implements PropertiesPackage {
    ...
    public EAttribute getAbstractPageDescription_PreconditionExpression() {
        return (EAttribute) abstractPageDescriptionEClass.getEStructuralFeatures().get(4);
    }
    ...
    public EAttribute getAbstractGroupDescription_PreconditionExpression() {
        return (EAttribute) abstractGroupDescriptionEClass.getEStructuralFeatures().get(4);
    }
    ...
    public EReference getAbstractGroupDescription_Extends() {
        return (EReference) abstractGroupDescriptionEClass.getEStructuralFeatures().get(9);
    }
    ...
    public EAttribute getAbstractGroupDescription_FilterConditionalStylesFromExtendedGroupExpression() {
        return (EAttribute) abstractGroupDescriptionEClass.getEStructuralFeatures().get(12);
    }
    ...
    public EReference getAbstractDynamicMappingIfDescription_Extends() {
        return (EReference) abstractDynamicMappingIfDescriptionEClass.getEStructuralFeatures().get(3);
    }
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getAbstractPageDescription_Label(), ecorePackage.getEString(), "label", null, 0, 1, AbstractPageDescription.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, //$NON-NLS-1$
                EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        initEAttribute(getAbstractPageDescription_LabelExpression(), theDescriptionPackage.getInterpretedExpression(), "labelExpression", null, 1, 1, AbstractPageDescription.class, //$NON-NLS-1$
                ...
                EPackageImpl.IS_ORDERED);
        initEAttribute(getAbstractPageDescription_DomainClass(), theDescriptionPackage.getTypeName(), "domainClass", null, 1, 1, AbstractPageDescription.class, !EPackageImpl.IS_TRANSIENT, //$NON-NLS-1$
                !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        ...
        initEAttribute(getAbstractGroupDescription_Label(), ecorePackage.getEString(), "label", null, 0, 1, AbstractGroupDescription.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, //$NON-NLS-1$
                EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        initEAttribute(getAbstractGroupDescription_LabelExpression(), theDescriptionPackage.getInterpretedExpression(), "labelExpression", null, 1, 1, AbstractGroupDescription.class, //$NON-NLS-1$
                !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED,
                EPackageImpl.IS_ORDERED);
        initEAttribute(getAbstractGroupDescription_DomainClass(), theDescriptionPackage.getTypeName(), "domainClass", null, 1, 1, AbstractGroupDescription.class, !EPackageImpl.IS_TRANSIENT, //$NON-NLS-1$
                !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        ...
        initEClass(abstractTextAreaDescriptionEClass, AbstractTextAreaDescription.class, "AbstractTextAreaDescription", EPackageImpl.IS_ABSTRACT, !EPackageImpl.IS_INTERFACE, //$NON-NLS-1$
                EPackageImpl.IS_GENERATED_INSTANCE_CLASS);
        initEAttribute(getAbstractTextAreaDescription_LineCount(), ecorePackage.getEInt(), "lineCount", null, 0, 1, AbstractTextAreaDescription.class, !EPackageImpl.IS_TRANSIENT, //$NON-NLS-1$
                !EPackageImpl.IS_VOLATILE, EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
