...
/**
 * Property section for "value expression" feature of the Markdown widget description.
 * 
 * @author Arthur Daussy
 *
 */
@SuppressWarnings("restriction")
public class ExtMarkdownDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection {

    @Override
    protected String getDefaultLabelText() {
        return Messages.ExtMarkdownDescriptionValueExpressionPropertySection_DefaultLabel;
    }
    ...
    protected String getToolTipText() {
        return Messages.ExtMarkdownDescriptionValueExpressionPropertySection_Tooltip;
    }

    @Override
    public EAttribute getFeature() {
        return PropertiesMarkupWidgetsPackage.eINSTANCE.getExtMarkdownDescription_ValueExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ExtMarkdownDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
