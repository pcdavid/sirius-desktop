...
public class RepresentationCreationDescriptionItemProvider extends AbstractToolDescriptionItemProvider {
     ...
     * @generated
     */
    public RepresentationCreationDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ToolPackage.Literals.REPRESENTATION_CREATION_DESCRIPTION__INITIAL_OPERATION);
            childrenFeatures.add(ToolPackage.Literals.REPRESENTATION_CREATION_DESCRIPTION__CONTAINER_VIEW_VARIABLE);
            childrenFeatures.add(ToolPackage.Literals.REPRESENTATION_CREATION_DESCRIPTION__REPRESENTATION_NAME_VARIABLE);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(RepresentationCreationDescription.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.REPRESENTATION_CREATION_DESCRIPTION__INITIAL_OPERATION, ToolFactory.eINSTANCE.createInitialOperation()));

        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.REPRESENTATION_CREATION_DESCRIPTION__CONTAINER_VIEW_VARIABLE, ToolFactory.eINSTANCE.createContainerViewVariable()));

        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.REPRESENTATION_CREATION_DESCRIPTION__REPRESENTATION_NAME_VARIABLE, ToolFactory.eINSTANCE.createNameVariable()));
    }
