...
* <span class="label label-success">Added</span> It is now possible to use a rotatable node style through the @org.eclipse.sirius.rotatable@ extension-point. See the "developer documentation":developer/extensions-use_rotatable_node.html for more details.
