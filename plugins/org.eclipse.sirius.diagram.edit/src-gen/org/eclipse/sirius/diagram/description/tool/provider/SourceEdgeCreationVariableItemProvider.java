...
public class SourceEdgeCreationVariableItemProvider extends AbstractVariableItemProvider {
     ...
     * @generated
     */
    public SourceEdgeCreationVariableItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceEdgeCreationVariable"));
    }
    ...
    public String getText(Object object) {
        String label = ((SourceEdgeCreationVariable) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_SourceEdgeCreationVariable_type") : getString("_UI_SourceEdgeCreationVariable_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SourceEdgeCreationVariable.class)) {
        case org.eclipse.sirius.diagram.description.tool.ToolPackage.SOURCE_EDGE_CREATION_VARIABLE__SUB_VARIABLES:
