 ...
 * {@link org.eclipse.sirius.properties.CheckboxWidgetStyle} object. <!--
...
public class CheckboxWidgetStyleItemProvider extends WidgetStyleItemProvider {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/CheckboxWidgetStyle")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_CheckboxWidgetStyle_type") : //$NON-NLS-1$
                getString("_UI_CheckboxWidgetStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
