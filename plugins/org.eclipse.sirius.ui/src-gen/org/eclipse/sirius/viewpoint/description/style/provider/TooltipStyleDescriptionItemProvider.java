 ...
 * @generated
 */
public class TooltipStyleDescriptionItemProvider extends AbstractSiriusItemProvider
     ...
     * @generated
     */
    public TooltipStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addTooltipExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                StylePackage.Literals.TOOLTIP_STYLE_DESCRIPTION__TOOLTIP_EXPRESSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_GeneralPropertyCategory"), //$NON-NLS-1$
                null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/TooltipStyleDescription")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((TooltipStyleDescription) object).getTooltipExpression();
        return label == null || label.length() == 0 ? getString("_UI_TooltipStyleDescription_type") : //$NON-NLS-1$
                getString("_UI_TooltipStyleDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(TooltipStyleDescription.class)) {
