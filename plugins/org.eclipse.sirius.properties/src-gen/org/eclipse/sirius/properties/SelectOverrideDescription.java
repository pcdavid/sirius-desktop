 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.SelectOverrideDescription#getOverrides
 * <em>Overrides</em>}</li>
...
public interface SelectOverrideDescription extends AbstractSelectDescription, AbstractOverrideDescription {
     ...
     * Overridden Select Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Conditional Styles From Overridden
     * Select Expression</em>' attribute isn't clear, there really should be
     ...
     *            Overridden Select Expression</em>' attribute.
