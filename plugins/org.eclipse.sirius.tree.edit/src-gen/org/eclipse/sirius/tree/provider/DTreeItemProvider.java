...
public class DTreeItemProvider extends DRepresentationItemProvider {
    ...
    protected void addSemanticElementsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DTree_semanticElements_feature"), getString("_UI_PropertyDescriptor_description", "_UI_DTree_semanticElements_feature", "_UI_DTree_type"),
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DTree_description_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_DTree_description_feature", "_UI_DTree_type"), TreePackage.Literals.DTREE__DESCRIPTION, true, false, true, null, null, null));
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/DTree"));
    }
