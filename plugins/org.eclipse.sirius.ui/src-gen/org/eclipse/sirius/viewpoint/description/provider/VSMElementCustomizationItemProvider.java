 ...
 * @generated
 */
public class VSMElementCustomizationItemProvider extends AbstractSiriusItemProvider
     ...
     * @generated
     */
    public VSMElementCustomizationItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DescriptionPackage.Literals.VSM_ELEMENT_CUSTOMIZATION__FEATURE_CUSTOMIZATIONS);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(VSMElementCustomization.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.VSM_ELEMENT_CUSTOMIZATION__FEATURE_CUSTOMIZATIONS, DescriptionFactory.eINSTANCE.createEAttributeCustomization()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.VSM_ELEMENT_CUSTOMIZATION__FEATURE_CUSTOMIZATIONS, DescriptionFactory.eINSTANCE.createEReferenceCustomization()));
    }
