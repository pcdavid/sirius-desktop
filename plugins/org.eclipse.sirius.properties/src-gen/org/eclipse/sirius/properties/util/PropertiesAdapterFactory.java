...
public class PropertiesAdapterFactory extends AdapterFactoryImpl {
    ...
    protected PropertiesSwitch<Adapter> modelSwitch = new PropertiesSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseImageViewerWidgetStyle(ImageViewerWidgetStyle object) {
            return createImageViewerWidgetStyleAdapter();
        }
        ...
        @Override
        public Adapter caseImageViewerWidgetConditionalStyle(ImageViewerWidgetConditionalStyle object) {
            return createImageViewerWidgetConditionalStyleAdapter();
        }
     ...
     * Viewer Description</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     *
     ...
     * Viewer Widget Style</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     *
     ...
     * @generated
     */
    public Adapter createImageViewerWidgetStyleAdapter() {
        return null;
    }
     ...
     * @generated
     */
    public Adapter createImageViewerWidgetConditionalStyleAdapter() {
        return null;
    }
