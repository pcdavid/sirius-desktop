 ...
 * @generated
 */
public class ColorStepItemProvider extends AbstractSiriusItemProvider
    ...
    protected void addAssociatedValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ColorStep_associatedValue_feature"), //$NON-NLS-1$
    ...
    protected void addAssociatedColorPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ColorStep_associatedColor_feature"), //$NON-NLS-1$
