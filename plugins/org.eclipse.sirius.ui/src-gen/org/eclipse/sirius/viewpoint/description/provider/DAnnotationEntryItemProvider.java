 ...
 * {@link org.eclipse.sirius.viewpoint.description.DAnnotationEntry} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class DAnnotationEntryItemProvider extends AbstractSiriusItemProvider
     ...
     * @generated
     */
    public DAnnotationEntryItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addSourcePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DAnnotationEntry_source_feature"), //$NON-NLS-1$
    ...
    protected void addDetailsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DAnnotationEntry_details_feature"), //$NON-NLS-1$
    ...
    /**
     * This returns DAnnotationEntry.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DAnnotationEntry.class)) {
