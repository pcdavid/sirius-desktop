 ...
 * {@link org.eclipse.sirius.properties.AbstractCheckboxDescription} object.
...
public class AbstractCheckboxDescriptionItemProvider extends AbstractWidgetDescriptionItemProvider {
    ...
    public String getText(Object object) {
        String label = crop(((AbstractCheckboxDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_AbstractCheckboxDescription_type") : //$NON-NLS-1$
                getString("_UI_AbstractCheckboxDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(AbstractCheckboxDescription.class)) {
