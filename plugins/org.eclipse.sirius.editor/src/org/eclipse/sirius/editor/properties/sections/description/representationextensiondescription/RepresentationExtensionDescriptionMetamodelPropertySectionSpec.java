...
public class RepresentationExtensionDescriptionMetamodelPropertySectionSpec extends RepresentationDescriptionMetamodelPropertySectionSpec {
    ...
    protected void addButtons() {
        ...
        this.descriptionMetamodelsUpdater = new DescriptionMetamodelsUpdater(representationExtensionDescription, DescriptionPackage.eINSTANCE.getRepresentationDescription_Metamodel());
