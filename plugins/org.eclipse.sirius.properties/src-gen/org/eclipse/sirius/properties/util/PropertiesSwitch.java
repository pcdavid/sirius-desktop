...
public class PropertiesSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case PropertiesPackage.DATE_DESCRIPTION: {
            DateDescription dateDescription = (DateDescription) theEObject;
            T result = caseDateDescription(dateDescription);
            if (result == null) {
                result = caseWidgetDescription(dateDescription);
            }
            if (result == null) {
                result = caseControlDescription(dateDescription);
            }
            if (result == null) {
                result = defaultCase(theEObject);
            }
        ...
        case PropertiesPackage.DATE_WIDGET_STYLE: {
            DateWidgetStyle dateWidgetStyle = (DateWidgetStyle) theEObject;
            T result = caseDateWidgetStyle(dateWidgetStyle);
            if (result == null) {
                result = caseWidgetStyle(dateWidgetStyle);
            }
            if (result == null) {
                result = defaultCase(theEObject);
            }
        ...
        case PropertiesPackage.DATE_WIDGET_CONDITIONAL_STYLE: {
            DateWidgetConditionalStyle dateWidgetConditionalStyle = (DateWidgetConditionalStyle) theEObject;
            T result = caseDateWidgetConditionalStyle(dateWidgetConditionalStyle);
            if (result == null) {
                result = caseWidgetConditionalStyle(dateWidgetConditionalStyle);
            }
            if (result == null) {
                result = defaultCase(theEObject);
            }
     ...
     * @generated
     */
    public T caseDateDescription(DateDescription object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseDateWidgetStyle(DateWidgetStyle object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseDateWidgetConditionalStyle(DateWidgetConditionalStyle object) {
        return null;
    }
