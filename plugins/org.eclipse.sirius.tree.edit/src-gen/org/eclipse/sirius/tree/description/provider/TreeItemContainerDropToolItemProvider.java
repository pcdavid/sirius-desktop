...
import org.eclipse.sirius.edit.tools.api.provider.ItemProviderHelper;
...
public class TreeItemContainerDropToolItemProvider extends MappingBasedToolDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__OLD_CONTAINER);
            childrenFeatures.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_CONTAINER);
            childrenFeatures.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__ELEMENT);
            childrenFeatures.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_VIEW_CONTAINER);
            childrenFeatures.add(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__PRECEDING_SIBLINGS);
    ...
    protected void collectNewChildDescriptorsGen(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__ELEMENT, ToolFactory.eINSTANCE.createElementDropVariable()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__NEW_VIEW_CONTAINER, ToolFactory.eINSTANCE.createContainerViewVariable()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.TREE_ITEM_CONTAINER_DROP_TOOL__PRECEDING_SIBLINGS, DescriptionFactory.eINSTANCE.createPrecedingSiblingsVariables()));
    }
