...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ext Nebula Rich Text Widget Conditional Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.properties.ext.widgets.nebula.propertiesextwidgetsnebula.impl.ExtNebulaRichTextWidgetConditionalStyleImpl#getStyle <em>Style</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExtNebulaRichTextWidgetConditionalStyleImpl extends WidgetConditionalStyleImpl
		implements ExtNebulaRichTextWidgetConditionalStyle {
	/**
	 ...
	 * @generated
	 */
	protected ExtNebulaRichTextWidgetConditionalStyleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PropertiesExtWidgetsNebulaPackage.Literals.EXT_NEBULA_RICH_TEXT_WIDGET_CONDITIONAL_STYLE;
	}
	...
	public NotificationChain basicSetStyle(ExtNebulaRichTextWidgetStyle newStyle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PropertiesExtWidgetsNebulaPackage.EXT_NEBULA_RICH_TEXT_WIDGET_CONDITIONAL_STYLE__STYLE, oldStyle,
					newStyle);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setStyle(ExtNebulaRichTextWidgetStyle newStyle) {
		if (newStyle != style) {
			...
			if (style != null)
				msgs = ((InternalEObject) style).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- PropertiesExtWidgetsNebulaPackage.EXT_NEBULA_RICH_TEXT_WIDGET_CONDITIONAL_STYLE__STYLE,
						null, msgs);
			if (newStyle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PropertiesExtWidgetsNebulaPackage.EXT_NEBULA_RICH_TEXT_WIDGET_CONDITIONAL_STYLE__STYLE, newStyle,
					newStyle));
	}
...
} //ExtNebulaRichTextWidgetConditionalStyleImpl
