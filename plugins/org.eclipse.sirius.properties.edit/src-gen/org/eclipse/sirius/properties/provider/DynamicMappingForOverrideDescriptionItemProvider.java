...
public class DynamicMappingForOverrideDescriptionItemProvider extends AbstractDynamicMappingForDescriptionItemProvider {
    ...
    /**
     * This adds a property descriptor for the Filter Ifs From Overridden
     * Dynamic Mapping For Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((DynamicMappingForOverrideDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_DynamicMappingForOverrideDescription_type") : //$NON-NLS-1$
                getString("_UI_DynamicMappingForOverrideDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
