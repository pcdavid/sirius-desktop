 ...
 * @author nlepine
 */
public class STD011 extends AbstractSiriusSwtBotGefTestCase {
    ...
    private static final String MODEL = "STD-TEST-011.ecore";

    private static final String SESSION_FILE = "STD-TEST-011.aird";

    private static final String DATA_UNIT_DIR = "data/unit/std/011/";
     ...
     *             Test error.
     */
    public void testSTD011() throws Exception {
