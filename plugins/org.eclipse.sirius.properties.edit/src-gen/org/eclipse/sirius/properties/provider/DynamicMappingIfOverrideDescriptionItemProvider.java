...
public class DynamicMappingIfOverrideDescriptionItemProvider extends AbstractDynamicMappingIfDescriptionItemProvider {
    ...
    /**
     * This returns DynamicMappingIfOverrideDescription.gif. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = ((DynamicMappingIfOverrideDescription) object).getPredicateExpression();
        return label == null || label.length() == 0 ? getString("_UI_DynamicMappingIfOverrideDescription_type") : //$NON-NLS-1$
                getString("_UI_DynamicMappingIfOverrideDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
