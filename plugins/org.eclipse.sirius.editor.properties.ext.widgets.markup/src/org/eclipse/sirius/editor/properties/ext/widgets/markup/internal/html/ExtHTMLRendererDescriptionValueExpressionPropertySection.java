...
/**
 * Property section for "value expression" feature of the HTML renderer widget description.
 * 
 * @author Arthur Daussy
 *
 */
@SuppressWarnings("restriction")
public class ExtHTMLRendererDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection {

	@Override
	protected String getDefaultLabelText() {
        return Messages.ExtHTMLRendererDescriptionValueExpressionPropertySection_DefaultLabel;
	}
	...
	protected String getToolTipText() {
        return Messages.ExtHTMLRendererDescriptionValueExpressionPropertySection_Tooltip;
	}

	@Override
	public EAttribute getFeature() {
		return PropertiesMarkupWidgetsPackage.eINSTANCE.getExtHTMLRendererDescription_ValueExpression();
	}
		...
		return new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
						ExtHTMLRendererDescriptionValueExpressionPropertySection.this, text.getText());
				dialog.open();
