...
public class TreeItemDeletionToolItemProvider extends TreeItemToolItemProvider {
	...
	/**
	 * This returns TreeItemDeletionTool.gif.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator()
						.getImage("full/obj16/TreeItemDeletionTool"));
	}
	...
	public String getText(Object object) {
		String label = new IdentifiedElementQuery((TreeItemDeletionTool) object)
				.getLabel();
		return StringUtil.isEmpty(label) ? getString("_UI_TreeItemDeletionTool_type")
				: getString("_UI_TreeItemDeletionTool_type") + " " + label;
	}
