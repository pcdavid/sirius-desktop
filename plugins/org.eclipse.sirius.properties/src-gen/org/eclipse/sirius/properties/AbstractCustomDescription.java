 ...
 * Custom Description</b></em>'. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.AbstractCustomDescription#getCustomExpressions
 * <em>Custom Expressions</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.AbstractCustomDescription#getCustomOperations
 * <em>Custom Operations</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.AbstractCustomDescription#getStyle
 * <em>Style</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.AbstractCustomDescription#getConditionalStyles
 * <em>Conditional Styles</em>}</li>
 * <li>{@link org.eclipse.sirius.properties.AbstractCustomDescription#getExtends
 * <em>Extends</em>}</li>
...
public interface AbstractCustomDescription extends AbstractWidgetDescription {
     ...
     * <p>
     * If the meaning of the '<em>Filter Conditional Styles From Extended Custom
     ...
     *         Custom Expression</em>' attribute.
     ...
     *            Extended Custom Expression</em>' attribute.
