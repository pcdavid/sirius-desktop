...
public abstract class AbstractDTreeEditor extends EditorPart
    ...
    /**
     * Tells if the {@link Resource} associated to the specified <code>editorInput</code> exists or not.
     * 
     * @param editorInput
     *            the specifed {@link IEditorInput}
     * @return false if the {@link Resource} associated to the specified <code>editorInput</code> exists, true else
     */
