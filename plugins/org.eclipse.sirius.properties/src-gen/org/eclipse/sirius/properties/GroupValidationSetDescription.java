...
public interface GroupValidationSetDescription extends EObject {
    /**
     * Returns the value of the '<em><b>Semantic Validation Rules</b></em>'
     * containment reference list. The list contents are of type
     * {@link org.eclipse.sirius.viewpoint.description.validation.SemanticValidationRule}.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Semantic Validation Rules</em>' containment
    ...
    /**
     * Returns the value of the '<em><b>Property Validation Rules</b></em>'
     * containment reference list. The list contents are of type
     * {@link org.eclipse.sirius.properties.PropertyValidationRule}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Property Validation Rules</em>' containment
     * reference list isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Property Validation Rules</em>' containment
     *         reference list.
