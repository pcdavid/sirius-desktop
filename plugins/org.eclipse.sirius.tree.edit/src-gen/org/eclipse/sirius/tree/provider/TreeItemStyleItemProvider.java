...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.tree.TreeItemStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TreeItemStyleItemProvider extends StyleItemProvider {
	...
	protected void addLabelSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_BasicLabelStyle_labelSize_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_BasicLabelStyle_labelSize_feature",
						"_UI_BasicLabelStyle_type"),
				ViewpointPackage.Literals.BASIC_LABEL_STYLE__LABEL_SIZE, true,
	...
	protected void addLabelFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_BasicLabelStyle_labelFormat_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_BasicLabelStyle_labelFormat_feature",
						"_UI_BasicLabelStyle_type"),
				ViewpointPackage.Literals.BASIC_LABEL_STYLE__LABEL_FORMAT,
	...
	protected void addShowIconPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_BasicLabelStyle_showIcon_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_BasicLabelStyle_showIcon_feature",
						"_UI_BasicLabelStyle_type"),
				ViewpointPackage.Literals.BASIC_LABEL_STYLE__SHOW_ICON, true,
	...
	protected void addIconPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_BasicLabelStyle_iconPath_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_BasicLabelStyle_iconPath_feature",
						"_UI_BasicLabelStyle_type"),
				ViewpointPackage.Literals.BASIC_LABEL_STYLE__ICON_PATH, true,
	...
	protected void addLabelColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_BasicLabelStyle_labelColor_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_BasicLabelStyle_labelColor_feature",
						"_UI_BasicLabelStyle_type"),
				ViewpointPackage.Literals.BASIC_LABEL_STYLE__LABEL_COLOR, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addLabelAlignmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_LabelStyle_labelAlignment_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_LabelStyle_labelAlignment_feature",
						"_UI_LabelStyle_type"),
				ViewpointPackage.Literals.LABEL_STYLE__LABEL_ALIGNMENT, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_TreeItemStyle_backgroundColor_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_TreeItemStyle_backgroundColor_feature",
						"_UI_TreeItemStyle_type"),
				TreePackage.Literals.TREE_ITEM_STYLE__BACKGROUND_COLOR, true,
				false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/TreeItemStyle"));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_TreeItemStyle_type") + " "
				+ treeItemStyle.getLabelSize();
	}
