 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.properties.ListOverrideDescription#getOverrides
 * <em>Overrides</em>}</li>
...
public interface ListOverrideDescription extends AbstractListDescription, AbstractOverrideDescription {
     ...
     * Overridden List Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Conditional Styles From Overridden List
     ...
     *            Overridden List Expression</em>' attribute.
    ...
    /**
     * Returns the value of the '<em><b>Filter Actions From Overridden List
     * Expression</b></em>' attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Filter Actions From Overridden List
     * Expression</em>' attribute isn't clear, there really should be more of a
     * description here...
     * </p>
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Filter Actions From Overridden List
     ...
     * <em>Filter Actions From Overridden List Expression</em>}' attribute. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Filter Actions From Overridden List
     *            Expression</em>' attribute.
