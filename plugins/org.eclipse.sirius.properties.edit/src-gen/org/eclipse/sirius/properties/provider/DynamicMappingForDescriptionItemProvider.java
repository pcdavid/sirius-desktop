 ...
 * {@link org.eclipse.sirius.properties.DynamicMappingForDescription} object.
...
public class DynamicMappingForDescriptionItemProvider extends ControlDescriptionItemProvider {
    ...
    /**
     * This returns DynamicMappingForDescription.gif. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((DynamicMappingForDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_DynamicMappingForDescription_type") : //$NON-NLS-1$
                getString("_UI_DynamicMappingForDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
