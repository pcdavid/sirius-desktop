 ...
 * {@link org.eclipse.sirius.viewpoint.description.Environment} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class EnvironmentItemProvider extends AbstractSiriusItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DescriptionPackage.Literals.ENVIRONMENT__SYSTEM_COLORS);
            childrenFeatures.add(DescriptionPackage.Literals.ENVIRONMENT__DEFAULT_TOOLS);
            childrenFeatures.add(DescriptionPackage.Literals.ENVIRONMENT__LABEL_BORDER_STYLES);
        }
    ...
    /**
     * This returns Environment.gif. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     */
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.ENVIRONMENT__DEFAULT_TOOLS, ToolFactory.eINSTANCE.createPaneBasedSelectionWizardDescription()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.ENVIRONMENT__DEFAULT_TOOLS, ToolFactory.eINSTANCE.createOperationAction()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.ENVIRONMENT__DEFAULT_TOOLS, ToolFactory.eINSTANCE.createExternalJavaAction()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.ENVIRONMENT__DEFAULT_TOOLS, ToolFactory.eINSTANCE.createExternalJavaActionCall()));
