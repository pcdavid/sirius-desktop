...
public interface PropertiesFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>File Picker Description</em>'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return a new object of class '<em>File Picker Description</em>'.
     * @generated
     */
    FilePickerDescription createFilePickerDescription();
    ...
    /**
     * Returns a new object of class '<em>File Picker Widget Style</em>'. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @return a new object of class '<em>File Picker Widget Style</em>'.
     * @generated
     */
    FilePickerWidgetStyle createFilePickerWidgetStyle();
    ...
    /**
     * Returns a new object of class '<em>File Picker Widget Conditional
     * Style</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return a new object of class '<em>File Picker Widget Conditional
     *         Style</em>'.
     * @generated
     */
    FilePickerWidgetConditionalStyle createFilePickerWidgetConditionalStyle();
