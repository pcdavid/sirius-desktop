...
/**
 * Abstract Model Marker Navigation Provider this abstract class provides the
 * necessary wrapping required to perform model operations related to the
 * navigation of markers. If the marker attributes contain model element
...
public abstract class AbstractModelMarkerNavigationProvider extends AbstractMarkerNavigationProvider {
    ...
    /**
     * Perform the feedback for navigating to the given marker within a model
     * read action.
     */
    @Override
     ...
     * <ul>
     * <li>any ID in the list that is a URI fragment (i.e., does not include a
     * resource URI) is assumed to be relative to the URI of the specified
     * <code>resource</code></li>
     * <li>any ID in the list that does not reference an object in the specified
     * <code>resource</code> must be a fully-qualified URI (i.e., it must
     * include a resource URI part)</li>
     * </ul>
     ...
     * 
     * @param ids
     *            a list of element IDs, as described above
     * @param resource
     *            the resource that has a marker from which the list of IDs was
     *            extracted. URI fragments in the <code>ids</code> list are
     ...
     *         the <code>ids</code>, though not including any elements that
     *         could not be located (due to stale IDs)
     */
