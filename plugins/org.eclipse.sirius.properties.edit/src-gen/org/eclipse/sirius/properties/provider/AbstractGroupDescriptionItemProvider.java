 ...
 * {@link org.eclipse.sirius.properties.AbstractGroupDescription} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class AbstractGroupDescriptionItemProvider extends DocumentedElementDescriptionItemProvider {
    /**
    ...
    protected void addIdentifierPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_AbstractGroupDescription_identifier_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractGroupDescription_identifier_feature", "_UI_AbstractGroupDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        PropertiesPackage.Literals.ABSTRACT_GROUP_DESCRIPTION__IDENTIFIER, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
     ...
     * Extended Group Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = crop(((AbstractGroupDescription) object).getDocumentation());
        return label == null || label.length() == 0 ? getString("_UI_AbstractGroupDescription_type") : //$NON-NLS-1$
                getString("_UI_AbstractGroupDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
