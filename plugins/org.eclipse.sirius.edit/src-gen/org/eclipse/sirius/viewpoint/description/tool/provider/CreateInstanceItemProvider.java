...
public class CreateInstanceItemProvider extends ContainerModelOperationItemProvider {
    ...
    protected void addVariableNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CreateInstance_variableName_feature"), getString("_UI_CreateInstance_variableName_description"), ToolPackage.Literals.CREATE_INSTANCE__VARIABLE_NAME, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_GeneralPropertyCategory"), null));
    }
